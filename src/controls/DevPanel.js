...
export class DevPanel {
  ...
  handleInputChange(id, value) {
    switch (id) {
      ...
      case 'bloom-strength':
        ...
        this.postProcessing?.updateBloom(value, CONFIG.bloom.radius, CONFIG.bloom.threshold);
        break;
        
      case 'bloom-radius':
        CONFIG.bloom.radius = value;
        this.postProcessing?.updateBloom(CONFIG.bloom.strength, value, CONFIG.bloom.threshold);
        break;
  ...
  resetSettings() {
    ...
    this.postProcessing?.updateBloom(CONFIG.bloom.strength, CONFIG.bloom.radius, CONFIG.bloom.threshold);
